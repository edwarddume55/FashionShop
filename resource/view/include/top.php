...
<html lang="en">
	<head>
		...
		<?php
			...
			if($pageName === 'index')
			{
				$pageTitle = ucwords('Online Clothware');
			}
			else
			{
		...
		<meta name="author" content="Edward Dume">
		<title> MudzofashionShop | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/logo.png">
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/kenya.png" alt="Kenya flag">ENGLISH</a>
								<div class="header-menu">
									<ul>
										<li><a href="#"><img src="public/assets/images/favicon/UG.png" alt="England flag">ENGLISH</a></li>
										<li><a href="#"><img src="public/assets/images/favicon/TZ.png" alt="France flag">SWAHILI</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 60px;" src="public/assets/images/favicon/faviconBackEnd.png" alt="SuperShop Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+254 790454567</strong></a>
							</div>
