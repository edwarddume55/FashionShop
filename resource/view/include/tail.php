						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>Mudzofasion infrastructure is developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>ImaraDaima, Nairobi, Kenya</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+254 7 12769188</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">mudzofashion@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank"> edward dume</a>
						</p>
						<div class="social-icons">
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/payment.jpg" alt=""></a>
